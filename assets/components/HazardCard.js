const HazardCard = ({ reports }) => {
  ...
  `<div class="sb-cards">
    <button class="sb-cards-btn--back"
      onclick="document.querySelector('.sb-cards').remove(); document.querySelector('.btn-report-hazard').style.display = 'flex'; document.querySelector('.sb-search-box--input').value='';">
