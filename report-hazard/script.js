...
form.addEventListener("submit", function (event) {
    ...
    const report = new Report(locationInput.value, categoryInput.value, typeInput.value, detailsInput.value, pictureInput.value)
...
function myFu() {
    ...
    review.innerHTML = `1.Location: ${locationInput.value}<br>`
