    ...
    return `
        <div style="display:flex; flex-direction:column; gap:2rem; justify-content:center; align-items:center; padding-top:3rem; padding-bottom:3rem; width: 100%;">
                ...
                <div style="display:flex; flex-direction:column; gap:0.75rem; width: 24.625rem">
                        <h2 class="text-center text-heading-2" style="margin: 0;">Looks like you haven't reported any hazards yet.</h2>
                        <p class="text-body-2 text-center text-neutral-600">Start by reporting a hazard to ensure a safe outdoors experience for everyone!<p>
                </div>
        </div>
